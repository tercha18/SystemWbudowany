/****************************************************************************/
/*  Definicje oznaczeñ wejœæ i wyjœæ obiektu "H"                            */
...
struct SchemWeX *WeH=(struct SchemWeX *)bWe;	// Wejœcia binarne (Czujniki X1..X16)
struct SchemWyX *WyH=(struct SchemWyX *)bWy;	// Wyjœcia binarne (Sygnalizatory Z1..Z8)
